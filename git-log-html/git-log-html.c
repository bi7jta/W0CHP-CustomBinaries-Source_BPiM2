...
static const char* git_log_command = "/usr/bin/git --work-tree=/var/www/dashboard \
	--git-dir=/var/www/dashboard/.git --no-pager log  --color=always --abbrev-commit \
	--decorate --date=relative -n20 --stat --abbrev=10 --format=format:'%C(bold blue)%h%C(reset) - \
